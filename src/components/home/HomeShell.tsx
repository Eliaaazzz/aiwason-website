...
import HomeNeonFlows from './HeroNeonFlows' // <-- change to './HomeNeonFlows' if that's your filename
import NewsSectionsSlideIn, { type NewsGroup } from '../news/NewsSectionsSlideIn'

const LOGO_SRC = '/res/logo.png?v=20250825'; 

/** Localized copy used in the hero + nav + slide subtitles */
const translations = {
  en: {
    ...
    features: {
      smartMonitoring: {
        ...
        description:
          'Real-time analytics with predictive maintenance powered by advanced AI algorithms',
      },
      highEfficiency: {
        title: 'ULTRA-HIGH EFFICIENCY',
        description:
          'Industry-leading power efficiency reduces operational costs and environmental impact',
      },
      fireResistant: {
        title: 'FIRE-RESISTANT CORE',
        description:
          '2-hour fire resistance rating ensures uninterrupted power delivery during critical situations',
      },
    },
  },
  zh: {
    ...
    features: {
      smartMonitoring: {
        title: 'AI智能监控',
        description: '基于先进AI算法的实时分析和预测性维护',
      },
      highEfficiency: {
        title: '超高效率',
      ...
      fireResistant: {
        title: '耐火核心技术',
        description: '2小时耐火等级，确保关键情况下的不间断电力传输',
      },
    },
  },
} as const
...
export default function HomeShell() {
  ...
  // Slides (hero uses company.jpg as requested)
  const slides = useMemo(
    () => [
      ...
      },
      {
        ...
        lines:
          language === 'en'
            ? ['ULTRA-HIGH', 'EFFICIENCY', 'RELIABILITY']
            : ['超高', '效率', '可靠性'],
      ...
      },
      {
        ...
        lines:
          language === 'en'
            ? ['FIRE-RESISTANT', 'CORE', 'TECHNOLOGY']
            : ['耐火', '核心', '技术'],
  ...
  // News sections (specific images per section)
      ...
      items: [
        {
          ...
          desc:
            language === 'en'
              ...
              : '发布耐火智能光电母线解决方案。',
          date: '2025/05/18',
          img: '/res/conference.jpg', // conference
      ...
      items: [
        {
          ...
          desc:
            language === 'en'
              ...
              : '更安全、更绿色的社区配电示范项目。',
          date: '2025/05/03',
          img: '/res/SheratonHotel.png', // SheratonHotel
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <HomeNeonFlows
        lang={language}
        imageSrc={tSlide?.img ?? '/res/company.jpg'}
        titleLines={
          Array.isArray(tSlide?.lines)
            ? tSlide.lines
            : [t.hero.title1, t.hero.title2, t.hero.title3]
        }
        description={
          tSlide?.subtitle ?? t.features.smartMonitoring.description
        }
        cta={{ href: '/products', label: t.hero.exploreBtn }}
        currentSlide={idx}
        totalSlides={slides.length}
        progressMs={SLIDES_MS}
        onSelectSlide={(i) => setIdx(i)}
      />

      {/* Unified news sections */}
