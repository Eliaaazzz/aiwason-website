...
const DataCenterPage = dynamic(
  () => import('@/components/solutions/DataCenterPage'),
  { loading: () => <div className="min-h-screen bg-white" aria-busy="true" /> },
)
